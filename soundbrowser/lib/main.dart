...
import 'package:soundbrowser/base/DrawPadWidget.dart';
import 'package:soundbrowser/page/DemoSplitWidget.dart';
import 'package:soundbrowser/page/MusicPlayerWidget.dart';
import 'package:soundbrowser/page/SoundPoolList.dart';
import 'package:soundbrowser/page/VideoWidget.dart';
...
import 'page/DrawWidget.dart';
import 'page/FileListWidget.dart';
import 'page/LogoWidget.dart';
import 'page/SoundListMainWidget.dart';
import 'page/SoundPoolList2.dart';
...
void main() {
  ...
  doWhenWindowReady(() {
    final win = appWindow;
    final initialSize = Size(640, 360);
    win.minSize = initialSize;
    win.size = initialSize;
    win.size = Size(480,720);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        "FileListWidget": (BuildContext context) => FileListWidget(),
        "DemoSplitWidget": (BuildContext context) => DemoSplitWidget(),
        "DrawPadWidget": (BuildContext context) => DrawPadWidget(),
        "VideoWidget": (BuildContext context) => VideoWidght(),
        "SoundPoolWidget": (BuildContext context) => SoundPoolWidget(),
        "SoundPoolList2Widget": (BuildContext context) => SoundPoolList2Widget(),
        "SoundListMainWidget": (BuildContext context) => SoundListMainWidget(),
      },
      home: FileListWidget(),
    );
  }
